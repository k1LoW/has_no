...
This plugin support following bind model practice.
...
And if you want to use model's bind property, use method @$this->Post->has('AssociationModelName')@ , @$this->Post->has(array('AssociationModelName1', 'AssociationModelName2'))@ or @$this->Post->hasAll()@ .